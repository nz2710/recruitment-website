                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6">
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <input type="job_title" class="form-control" name="" value="{{ $page_home_data->job_title }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6">
                                                                    <div class="mb-4">
                                                                        <label class="form-label">Job Location *</label>
                                                                        <input type="job_location" class="form-control" name="" value="{{ $page_home_data->job_location }}">
                                                                    </div> 
                                                                </div>                                    
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6">
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <input type="job_category" class="form-control" name="" value="{{ $page_home_data->job_category }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6">
                                                                    <div class="mb-4">
                                                                        <label class="form-label">Search *</label>
                                                                        <input type="search" class="form-control" name="" value="{{ $page_home_data->search }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="mb-4">
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <div>
                                                                    <input type="background" class="form-control mt_10" name="background">
                                                                </div>
                                                            </div>
                                                            <div class="mb-4">
