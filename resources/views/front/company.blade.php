...
<div class="page-top page-top-job-single page-top-company-single" style="background-image: url('{{ asset('uploads/'.$global_banner_data->banner_company_detail) }}')">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="item d-flex justify-content-start">
                                        ...
                                        <div class="text">
                                            <h3><a href="{{ route('job',$item->id) }}">{{ $item->title }}, {{ $company_single->company_name }}</a>
                                            </h3>
                                            <div class="detail-1 d-flex justify-content-start">
                                                <div class="category">
